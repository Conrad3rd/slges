...
echo "<a href='01_gallery.php?funk=filter_exclude&exclude=9031,9143,379,381,384,9141,133,490,9099,358#$bild_id'><button type='button' class='button is-link'>Gallerie</button></a>";
...
echo "<a href='/01_gallery.php?&hash_used=0#$bild_id'><button type='button' class='button is-link'>Hashtags anzahl</button></a>";
